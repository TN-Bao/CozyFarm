...
namespace CozyFarm.Feedback
{
    ...
    {
        [SerializeField] private List<AudioClip> _songToPlay = new List<AudioClip>();
        [SerializeField] private AudioSource _audioSource;
        [SerializeField] private float _fullVolumeDelay = 0.5f;
        ...
        private IEnumerator PlayNextSong()
        {
            ...
            _currentlyPlayedSongIndex = _currentlyPlayedSongIndex + 1 >= _songToPlay.Count
                ? 0 : _currentlyPlayedSongIndex + 1;
