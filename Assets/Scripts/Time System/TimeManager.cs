...
namespace CozyFarm.TimeSystem
{
    public class TimeManager : MonoBehaviour
    {
        ...
        public void GoToNextDay()
        {
            ...
            int tempWakeUpHour = _wakeUpHour;
        ...
        {
            return $"Season: {CalendarNameHelper.GetSeasonName(_calendar.Season)}," +
                $"Day: {_calendar.Day}, " +
                $"Weekday name: {CalendarNameHelper.GetWeekDayName(_calendar.WeekDay)}";
        }
    ...
    public class TimeEventArgs : EventArgs
    {
        ...
        public TimeEventArgs(bool seasonChanged, GameCalendar calendar, TimeSpan currentTime, bool theSameDay)
        {
        ...
        public TimeEventArgs(bool seasonChanged, int currentDay, int weekDay, int currentSeason,
